(() => {
  ...
  form.addEventListener("submit", (event) => {
    ...
    const message = [
      "Olá! Quero agendar uma sessão estratégica gratuita sobre a Blefaro 10.",
      "",
      `Nome: ${value("name")}`,
      `E-mail: ${value("email")}`,
      `WhatsApp: ${value("phone")}`,
      `Clínica: ${value("clinic")}`,
      `Dono ou sócio da clínica: ${value("owner")}`,
    ...
    resume.hidden = false;
    status.textContent =
      "Sua mensagem está pronta. Envie no WhatsApp para combinar o horário da sessão.";
